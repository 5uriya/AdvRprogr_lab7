...
## Build list for implementing our ridge regression in Caret package
...
```
The optimal lambda for model 1 was 1e-04.
...
With model 1, lambda 0.0001, we get the following results:
