...
## rigdereg() model prediction

In this section an example of using rigdereg() function from linreg package is provided. Firstly, a list of arguments for caret prediction function is created:
...
Ridgereg_model$grid <- function (x, y, len = NULL, search = "grid"){
    data.frame(lambda = c(0.5,1,2.5,4))
}

Ridgereg_model$fit <- function (x, y, param){
...
Now, this function is used in training the ridgereg() model:
